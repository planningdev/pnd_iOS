...
extension TabMenuItemCell {
    override var intrinsicContentSize: CGSize {
        ...
        case let .fixed(width: tabWidth, height: tabHeight):
            return CGSize(width: tabWidth + options.menuItemMargin * 2, height: tabHeight)
        case let .sizeToFit(minWidth, tabHeight):
    ...
    func highlightTitle(progress: CGFloat = 1.0) {
        ...
        self.itemLabel.textColor = UIColor.interpolate(from: options.menuTitleColor,
    ...
    func unHighlightTitle(progress: CGFloat = 1.0) {
        ...
        self.itemLabel.textColor = UIColor.interpolate(from: options.menuTitleSelectedColor,
